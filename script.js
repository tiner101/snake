...
var $Start = $('<input/>').attr({
    ...
    value: 'Start',
    id: 'start',
    style: 'position:absolute; top:50px;left:220px; zindex:2; font-size: 60px; padding: 5px 30px;'
});
$('body').append($Start);
var $Color = $('<input/>').attr({
    type: 'button',
    name: 'Color',
    value: 'Color',
    id: 'color',
    style: 'position:absolute; top:150px;left:220px; zindex:2; font-size: 60px; padding: 5px 23px;'
});
$('body').append($Color);
var $Hard = $('<input/>').attr({
    type: 'button',
    ...
    value: 'Hard',
    id: 'hard',
    style: 'position:absolute; top:250px;left:220px; zindex:2; font-size: 60px; padding: 5px 30px;'
});
$('body').append($Hard);
    $('#start').click(function() {
        $("#start, #color, #hard").hide();
